...
namespace fermat::uri {
    ...
    ///
    /// @details The UrlAggregator class aims to minimize temporary memory
    ...
    struct UrlAggregator : UrlBase {
        UrlAggregator() = default;

        UrlAggregator(const UrlAggregator &u) = default;

        UrlAggregator(UrlAggregator &&u) noexcept = default;

        UrlAggregator &operator=(UrlAggregator &&u) noexcept = default;

        UrlAggregator &operator=(const UrlAggregator &u) = default;

        ~UrlAggregator() override = default;
        ...
        get_href() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;

        /// The username getter steps are to return this's URL's username.
        /// This function does not allocate memory.
        /// @return a lightweight std::string_view.
        /// @see https://url.spec.whatwg.org/#dom-url-username
        [[nodiscard]] std::string_view get_username() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;

        /// The password getter steps are to return this's URL's password.
        /// This function does not allocate memory.
        /// @return a lightweight std::string_view.
        /// @see https://url.spec.whatwg.org/#dom-url-password
        [[nodiscard]] std::string_view get_password() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;

        /// Return this's URL's port, serialized.
        /// This function does not allocate memory.
        /// @return a lightweight std::string_view.
        /// @see https://url.spec.whatwg.org/#dom-url-port
        [[nodiscard]] std::string_view get_port() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;

        /// Return U+0023 (#), followed by this's URL's fragment.
        /// This function does not allocate memory.
        /// @return a lightweight std::string_view..
        /// @see https://url.spec.whatwg.org/#dom-url-hash
        [[nodiscard]] std::string_view get_hash() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;
        ...
        [[nodiscard]] std::string_view get_host() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;
        ...
        /// @see https://url.spec.whatwg.org/#dom-url-pathname
        [[nodiscard]] TURBO_FORCE_INLINE uint32_t get_pathname_length() const noexcept;

        /// Return U+003F (?), followed by this's URL's query.
        /// This function does not allocate memory.
        /// @return a lightweight std::string_view.
        /// @see https://url.spec.whatwg.org/#dom-url-search
        [[nodiscard]] std::string_view get_search() const noexcept TURBO_ATTRIBUTE_LIFETIME_BOUND;
        ...
        [[nodiscard]] TURBO_FORCE_INLINE const fermat::uri::UrlComponents &get_components()
        const noexcept;
        ...
        [[nodiscard]] fermat::KString to_diagram() const;
    ...
    private:
        ...
        friend void fermat::uri::helpers::strip_trailing_spaces_from_opaque_path<
            fermat::uri::UrlAggregator>(fermat::uri::UrlAggregator &url) noexcept;
        ...
        friend fermat::uri::UrlAggregator
        fermat::uri::parser::parse_url_impl<fermat::uri::UrlAggregator, false>(
            std::string_view, const fermat::uri::UrlAggregator *);

        fermat::KString buffer{};
        ...
        [[nodiscard]] TURBO_FORCE_INLINE bool is_at_path() const noexcept;
        ...
        TURBO_FORCE_INLINE bool parse_host(std::string_view input);

        inline void update_base_authority(std::string_view base_buffer,
                                          const fermat::uri::UrlComponents &base);
        ...
        [[nodiscard]] TURBO_FORCE_INLINE bool parse_scheme_with_colon(
            std::string_view input);

        TURBO_FORCE_INLINE uint32_t replace_and_resize(uint32_t start, uint32_t end,
                                                       std::string_view input);
        ...
        inline void copy_scheme(const UrlAggregator &u) noexcept;
    }; // UrlAggregator
