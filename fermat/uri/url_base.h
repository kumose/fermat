...
namespace fermat::uri {
    ...
    ///
    /// @details A UrlBase contains a few attributes: is_valid, has_opaque_path and
    /// type. All non-trivial implementation details are in derived classes such as
    /// fermat::uri::url and fermat::uri::UrlComponents.
    ///
    /// It is an abstract class that cannot be instantiated directly.
    struct UrlBase {
        virtual ~UrlBase() = default;
        ...
        /// URL hosts type
        UrlHostType host_type = UrlHostType::DEFAULT;

        /// @private
        fermat::uri::scheme::type type{fermat::uri::scheme::type::NOT_SPECIAL};

        /// A URL is special if its scheme is a special scheme. A URL is not special if
        /// its scheme is not a special scheme.
        [[nodiscard]] TURBO_FORCE_INLINE bool is_special() const noexcept;

        /// The origin getter steps are to return the serialization of this's URL's
        /// origin. [HTML]
        /// @return a newly allocated string.
        /// @see https://url.spec.whatwg.org/#concept-url-origin
        [[nodiscard]] virtual fermat::KString get_origin() const noexcept = 0;
        ...
        [[nodiscard]] TURBO_FORCE_INLINE uint16_t scheme_default_port() const noexcept;
        ...
        virtual TURBO_FORCE_INLINE size_t parse_port(std::string_view view) noexcept {
            return this->parse_port(view, false);
        }

        /// Returns a JSON string representation of this URL.
        [[nodiscard]] virtual fermat::KString to_string() const = 0;
