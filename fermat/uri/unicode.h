...
namespace fermat::uri::unicode {
    ...
    ///
    bool to_ascii(std::optional<fermat::KString> &out, std::string_view plain,
    ...
    TURBO_FORCE_INLINE constexpr bool is_forbidden_host_code_point(char c) noexcept;
    ...
    TURBO_FORCE_INLINE constexpr bool is_alnum_plus(char c) noexcept;
    ...
    TURBO_FORCE_INLINE constexpr bool is_ascii_hex_digit(char c) noexcept;
    ...
    TURBO_FORCE_INLINE constexpr bool is_c0_control_or_space(char c) noexcept;
    ...
    TURBO_FORCE_INLINE constexpr bool is_ascii_tab_or_newline(char c) noexcept;
    ...
    TURBO_FORCE_INLINE constexpr bool is_lowercase_hex(char c) noexcept;

    /// @private
    /// @details Convert hex to binary. Caller is responsible to ensure that
    /// the parameter is an hexadecimal digit (0-9, A-F, a-f).
    TURBO_FORCE_INLINE unsigned constexpr convert_hex_to_binary(char c) noexcept;
    ...
    fermat::KString percent_decode(std::string_view input, size_t first_percent);

    /// @private
    /// Returns a percent-encoding string whether percent encoding was needed or not.
    /// @see https://github.com/nodejs/node/blob/main/src/node_url.cc#L226
    fermat::KString percent_encode(std::string_view input,
    ...
    TURBO_FORCE_INLINE size_t percent_encode_index(std::string_view input,
                                                  const uint8_t character_set[]);
