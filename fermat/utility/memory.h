...
#include <fermat/utility/polymorphic_cast.h>
...
namespace fermat::ranges {
    ...
    private:
        static_assert(static_cast<bool>(output_iterator<O, Val>),
                      "Concept assertion failed : output_iterator<O, Val>");
        static_assert(static_cast<bool>(std::is_lvalue_reference<iter_reference_t<O> >()),
                      "Concept assertion failed : std::is_lvalue_reference<iter_reference_t<O>>()");
        O out_;
