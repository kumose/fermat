...
namespace fermat {
    ...
    inline void promote_heap_impl(RandomAccessIterator first, Distance topPosition, Distance position, T value) {
        for (Distance parentPosition = (position - 1) >> 1;
             // This formula assumes that (position > 0). // We use '>> 1' instead of '/ 2' because we have seen VC++ generate better code with >>.
    ...
    inline void promote_heap(RandomAccessIterator first, Distance topPosition, Distance position, T &&value) {
        ...
        promote_heap_impl<RandomAccessIterator, Distance, T &&, value_type>(
            first, topPosition, position, std::forward<T>(value));
    }
    ...
    inline void promote_heap(RandomAccessIterator first, Distance topPosition, Distance position, T &&value,
        ...
        promote_heap_impl<RandomAccessIterator, Distance, T &&, Compare, value_type>(
            first, topPosition, position, std::forward<T>(value), compare);
    }
    ...
    void adjust_heap_impl(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position,
        ...
        fermat::promote_heap<RandomAccessIterator, Distance, T>(first, topPosition, position,
    ...
    void adjust_heap(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position,
        ...
        adjust_heap_impl<RandomAccessIterator, Distance, const T &, const value_type>(
            first, topPosition, heapSize, position, std::forward<const T &>(value));
    }
    ...
    void adjust_heap(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position,
        ...
        adjust_heap_impl<RandomAccessIterator, Distance, T &&, value_type>(
            first, topPosition, heapSize, position, std::forward<T>(value));
    }
    ...
    void adjust_heap_impl(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position,
        ...
        fermat::promote_heap<RandomAccessIterator, Distance, T, Compare>(
            first, topPosition, position, std::forward<ValueType>(value), compare);
    }
    ...
    void adjust_heap(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position,
        ...
        adjust_heap_impl<RandomAccessIterator, Distance, const T &, Compare, const value_type>(
            first, topPosition, heapSize, position, std::forward<const T &>(value), compare);
    }
    ...
    void adjust_heap(RandomAccessIterator first, Distance topPosition, Distance heapSize, Distance position, T &&value,
        ...
        adjust_heap_impl<RandomAccessIterator, Distance, T &&, Compare, value_type>(
            first, topPosition, heapSize, position, std::forward<T>(value), compare);
    }
    ...
    inline void push_heap(RandomAccessIterator first, RandomAccessIterator last) {
        ...
        fermat::promote_heap<RandomAccessIterator, difference_type, value_type>
        (first, (difference_type) 0, (difference_type) (last - first - 1),
         std::forward<const value_type>(tempBottom));
    }
    ...
    inline void push_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare) {
        ...
        fermat::promote_heap<RandomAccessIterator, difference_type, value_type, Compare>
    ...
    inline void pop_heap(RandomAccessIterator first, RandomAccessIterator last) {
        ...
        *(last - 1) = std::forward<value_type>(*first);
        ...
        (first, (difference_type) 0, (difference_type) (last - first - 1), 0,
         std::forward<value_type>(tempBottom));
    }
    ...
    inline void pop_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare) {
        ...
        *(last - 1) = std::forward<value_type>(*first);
        ...
        (first, (difference_type) 0, (difference_type) (last - first - 1), 0,
         std::forward<value_type>(tempBottom), compare);
    }
    ...
    inline void sort_heap(RandomAccessIterator first, RandomAccessIterator last) {
        for (; (last - first) > 1; --last) // We simply use the heap to sort itself.
            fermat::pop_heap<RandomAccessIterator>(first, last);
    }
    ...
    inline void sort_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare) {
        for (; (last - first) > 1; --last) // We simply use the heap to sort itself.
            fermat::pop_heap<RandomAccessIterator, Compare>(first, last, compare);
    }
    ...
    inline void change_heap(RandomAccessIterator first, Distance heapSize, Distance position) {
        ...
        fermat::remove_heap<RandomAccessIterator, Distance>(first, heapSize, position);
    ...
    inline void change_heap(RandomAccessIterator first, Distance heapSize, Distance position, Compare compare) {
        ...
        fermat::remove_heap<RandomAccessIterator, Distance, Compare>(first, heapSize, position, compare);
    ...
    inline bool is_heap(RandomAccessIterator first, RandomAccessIterator last) {
        return (fermat::is_heap_until(first, last) == last);
    }
    ...
    inline bool is_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare) {
        return (fermat::is_heap_until(first, last, compare) == last);
    }
