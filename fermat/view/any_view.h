...
#include <fermat/utility/memory.h>
...
namespace fermat::ranges {
    ...
    enum class category {
        ...
        mask = random_access,
        ///<\brief Mask away any properties other than iterator
                                     ///< category
    ...
    namespace detail {
        ...
        struct RANGES_EMPTY_BASES any_input_view_impl
            ...
            static_assert(static_cast<bool>(any_compatible_range<Rng, Ref>),
                          "Concept assertion failed : any_compatible_range<Rng, Ref>");
            static_assert(static_cast<bool>(!Sized || (bool) sized_range<Rng>),
                          "Concept assertion failed : !Sized || (bool)sized_range<Rng>");
        ...
        struct any_cursor_impl : any_cloneable_cursor_interface<Ref, Cat> {
            static_assert(static_cast<bool>(convertible_to<iter_reference_t<I>, Ref>),
                          "Concept assertion failed : convertible_to<iter_reference_t<I>, Ref>");
            static_assert(static_cast<bool>((Cat & category::forward) == category::forward),
                          "Concept assertion failed : (Cat & category::forward) == category::forward");
        ...
        struct RANGES_EMPTY_BASES any_view_impl
            ...
            static_assert(static_cast<bool>(any_compatible_range<Rng, Ref>),
                          "Concept assertion failed : any_compatible_range<Rng, Ref>");
            static_assert(static_cast<bool>((Cat & category::sized) == category::none || (bool) sized_range<Rng>),
                          "Concept assertion failed : (Cat & category::sized) == category::none || (bool)sized_range<Rng>")
            ;
