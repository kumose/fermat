...
#include <fermat/utility/optional.h> // for non_propagating_cache
...
namespace fermat::ranges {
    ...
    private:
        friend range_access;
        static_assert(static_cast<bool>(input_range<Rng> && !forward_range<Rng>),
                      "Concept assertion failed : input_range<Rng> && !forward_range<Rng>");
    ...
    template<typename Rng>
    inline constexpr bool enable_borrowed_range<chunk_view<Rng> > =
