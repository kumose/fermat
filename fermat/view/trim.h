...
namespace fermat::ranges {
    ...
    public:
        static_assert(static_cast<bool>(bidirectional_range<Rng> && view_<Rng> && indirect_unary_predicate<
                                            Pred, iterator_t<Rng> > && common_range<Rng>),
                      "Concept assertion failed : bidirectional_range<Rng> && view_<Rng> && indirect_unary_predicate<Pred, iterator_t<Rng>> && common_range<Rng>")
        ;
    ...
    template<typename Rng, typename Pred>
    inline constexpr bool enable_borrowed_range<trim_view<Rng, Pred> > = //
    ...
    template<typename Rng, typename Pred>
    inline constexpr bool disable_sized_range<trim_view<Rng, Pred> > = true;
