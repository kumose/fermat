...
#include <fermat/detail/range_access.h>
...
namespace fermat::ranges {
    ...
    private:
        ...
        static_assert(static_cast<bool>(constructible_from<range_value_t<Rng>, range_reference_t<Rng> >),
                      "Concept assertion failed : constructible_from<range_value_t<Rng>, range_reference_t<Rng>>");
        friend range_access;
        Rng rng_;
        bool dirty_ = true;
