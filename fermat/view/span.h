...
namespace fermat::ranges {
    ...
    namespace detail {
        ...
        struct span_extent {
            static_assert(static_cast<bool>(N >= 0),
                          "Concept assertion failed : N >= 0");
            ...
            [[nodiscard]] constexpr span_index_t size() const noexcept {
                return N;
            }
    ...
    struct RANGES_EMPTY_BASES span
        ...
        static_assert(static_cast<bool>(std::is_object<T>::value),
                      "Concept assertion failed : std::is_object<T>::value");
