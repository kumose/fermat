...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// KM_INT128_INTRINSIC_AVAILABLE
//
#if (KM_COMPILER_INTMAX_SIZE >= 16) && (defined(KM_COMPILER_GNUC) || defined(KM_COMPILER_CLANG))
	// __int128_t/__uint128_t is supported
	#define KM_INT128_INTRINSIC_AVAILABLE 1
#else
	#define KM_INT128_INTRINSIC_AVAILABLE 0
#endif

///////////////////////////////////////////////////////////////////////////////////////////////////////
// KM_INT128_ALIGNAS
//
#if KM_INT128_INTRINSIC_AVAILABLE && !defined(KM_COMPILER_NO_ALIGNAS)
	#define KM_INT128_ALIGNAS alignas(unsigned __int128)
#else
	#define KM_INT128_ALIGNAS
#endif
...
//
#define KM_HAVE_INT128 1


///////////////////////////////////////////////////////////////////////////////////////////////////////
// uint128_t_base
//
struct KM_INT128_ALIGNAS int128_t_base
{
...
#if KM_INT128_INTRINSIC_AVAILABLE
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
constexpr inline int128_t_base::operator bool() const               { return mPart0 || mPart1; }
constexpr inline int128_t_base::operator char() const               { return static_cast<char>(Low()); }
#if KM_WCHAR_UNIQUE
// constexpr inline int128_t_base::operator char16_t() const           { return static_cast<char16_t>(Low()); }
// constexpr inline int128_t_base::operator char32_t() const           { return static_cast<char32_t>(Low()); }
// constexpr inline int128_t_base::operator wchar_t() const            { return static_cast<wchar_t>(Low()); }
#endif
constexpr inline int128_t_base::operator int() const                { return static_cast<int>(Low()); }
constexpr inline int128_t_base::operator long() const               { return static_cast<long>(Low()); }
constexpr inline int128_t_base::operator long long() const          { return static_cast<long long>(Low()); }
constexpr inline int128_t_base::operator short() const              { return static_cast<short>(Low()); }
constexpr inline int128_t_base::operator signed char() const        { return static_cast<signed char>(Low()); }
constexpr inline int128_t_base::operator unsigned char() const      { return static_cast<unsigned char>(Low()); }
constexpr inline int128_t_base::operator unsigned int() const       { return static_cast<unsigned int>(Low()); }
constexpr inline int128_t_base::operator unsigned long long() const { return static_cast<unsigned long long>(Low()); }
constexpr inline int128_t_base::operator unsigned long() const	   { return static_cast<unsigned long>(Low()); }
constexpr inline int128_t_base::operator unsigned short() const     { return static_cast<unsigned short>(Low()); }
constexpr inline int128_t_base::operator float() const              { return static_cast<float>(Low()); }
constexpr inline int128_t_base::operator double() const             { return static_cast<double>(Low()); }
constexpr inline int128_t_base::operator long double() const        { return static_cast<long double>(Low()); }
#if KM_INT128_INTRINSIC_AVAILABLE
constexpr inline int128_t_base::operator __int128() const           { return static_cast<__int128>(Low()); }
constexpr inline int128_t_base::operator unsigned __int128() const  { return static_cast<unsigned __int128>(Low()); }
#endif

inline void int128_t_base::SetBit(int nIndex, int value)
{
	// KM_ASSERT((nIndex >= 0) && (nIndex < 128));
...
inline void int128_t_base::DoubleToUint128(double value)
{
	...
	// KM_ASSERT(fabs(value) < 18446744073709551616.0); // Assert that the input is <= 64 bits of integer.
...
KM_DISABLE_VC_WARNING(4723) // warning C4723: potential divide by 0
...
// would work.
//
/* constexpr */ inline uint128_t UINT128_C(uint64_t nPart1, uint64_t nPart0) { return uint128_t(nPart0, nPart1); }
/* constexpr */ inline int128_t INT128_C(int64_t nPart1, int64_t nPart0) { return int128_t(static_cast<uint64_t>(nPart0), static_cast<uint64_t>(nPart1)); }
