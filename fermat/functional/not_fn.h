...
namespace fermat::ranges {
    ...
    private:
        static_assert(static_cast<bool>(same_as<FD, detail::decay_t<FD> > && move_constructible<FD>),
                      "Concept assertion failed : same_as<FD, detail::decay_t<FD>> && move_constructible<FD>");
