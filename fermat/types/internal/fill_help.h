...
#ifndef FERMAT_INTERNAL_FILL_HELP_H
#define FERMAT_INTERNAL_FILL_HELP_H
...
#if defined(KM_COMPILER_MICROSOFT) && (defined(KM_PROCESSOR_X86) || defined(KM_PROCESSOR_X86_64))
#include <intrin.h>
#endif
...
namespace fermat {
    ...
    inline void fill(ForwardIterator first, ForwardIterator last, const T &value) {
        fermat::fill_imp<std::is_scalar<T>::value>::do_fill(first, last, value);
        ...
        //const bool bEasyCopy = fermat::type_and<fermat::has_trivial_constructor<T>::value,
        //                                       fermat::integral_constant<bool, (sizeof(T) <= 16)>::value;
        //fermat::fill_imp<bEasyCopy>::do_fill(first, last, value);
    }

#if (defined(KM_COMPILER_GNUC) || defined(__clang__)) && (defined(KM_PROCESSOR_X86) || defined(KM_PROCESSOR_X86_64))
...
#elif defined(KM_COMPILER_MICROSOFT) && (defined(KM_PROCESSOR_X86) || defined(KM_PROCESSOR_X86_64))
#if defined(KM_PROCESSOR_X86_64)
    template<typename Value>
    inline void fill(uint64_t *first, uint64_t *last, Value c) {
    ...
    // It's debateable whether we should use 'char& c' or 'char c' here.
    {
    ...
    OutputIterator fill_n(OutputIterator first, Size n, const T &value) {
        return fermat::fill_n_imp<std::is_scalar<T>::value>::do_fill(first, n, value);
    }
