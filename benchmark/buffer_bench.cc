...
BENCHMARK_TEMPLATE(BM_ConstructSize, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_AppendBackSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_IterationSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_RandomAccessSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_InsertMiddleSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_EraseMiddleSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_ClearShrinkSmall, fermat::Buffer<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_Append, fermat::Buffer<int>)->Arg(1000)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_Iteration, fermat::Buffer<int>)->Arg(1000)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_RandomAccess, fermat::Buffer<int>)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_InsertMiddle, fermat::Buffer<int>)->Arg(1000)->Arg(10000);
...
BENCHMARK_TEMPLATE(BM_EraseMiddle, fermat::Buffer<int>)->Arg(1000)->Arg(10000);
...
BENCHMARK_TEMPLATE(BM_Sort, fermat::Buffer<int>)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_ClearAndShrink, fermat::Buffer<int>)->Arg(10000)->Arg(100000);
