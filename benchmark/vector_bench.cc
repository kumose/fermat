...
BENCHMARK_TEMPLATE(BM_EmplaceBackSmall, std::vector<int>)->RangeMultiplier(2)->Range(4, 1024);
BENCHMARK_TEMPLATE(BM_EmplaceBackSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_IterationSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_RandomAccessSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_InsertMiddleSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_EraseMiddleSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_ClearShrinkSmall, fermat::Vector<int>)->RangeMultiplier(2)->Range(4, 1024);
...
BENCHMARK_TEMPLATE(BM_EmplaceBack, std::vector<int>)->Arg(1000)->Arg(10000)->Arg(100000);
BENCHMARK_TEMPLATE(BM_EmplaceBack, fermat::Vector<int>)->Arg(1000)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_Iteration, fermat::Vector<int>)->Arg(1000)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_RandomAccess, fermat::Vector<int>)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_InsertMiddle, fermat::Vector<int>)->Arg(1000)->Arg(10000);
...
BENCHMARK_TEMPLATE(BM_EraseMiddle, fermat::Vector<int>)->Arg(1000)->Arg(10000);
...
BENCHMARK_TEMPLATE(BM_Sort, fermat::Vector<int>)->Arg(10000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BM_ClearAndShrink, fermat::Vector<int>)->Arg(10000)->Arg(100000);
