...
#include <fermat/utility/semiregular_box.h>   /// fermat::ranges::semiregular_box_t
...
TEST(SemiregularBoxTest, Issue1499) {
    ...
    fermat::ranges::semiregular_box_t<int> box1;
    fermat::ranges::semiregular_box_t<int &> box2;

    /// avoid unused variable warnings
    fermat::ranges::detail::ignore_unused(box1, box2);
}
